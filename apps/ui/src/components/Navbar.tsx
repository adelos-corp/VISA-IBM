        ...
        <GlassSurface width="100%" height={58} borderRadius={999} backgroundOpacity={0.22} saturation={1.2} distortionScale={-60} className="border border-white/15 shadow-2xl shadow-black/30">
          <nav className="flex h-full w-full items-center justify-between px-3 sm:px-4">
            ...
            <div className="flex items-center gap-1 text-xs">
              <Link href="/" className="rounded-full px-3.5 py-1.5 font-medium text-slate-300 hover:bg-white/10 hover:text-white">Overview</Link>
              <Link href="/projects" className="rounded-full px-3.5 py-1.5 font-medium text-slate-300 hover:bg-white/10 hover:text-white">Projects</Link>
