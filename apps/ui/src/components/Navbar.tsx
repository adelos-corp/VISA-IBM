    ...
    <div className="fixed inset-x-0 top-4 z-[100] px-4 sm:px-6 lg:px-8 pointer-events-none">
      <div className="mx-auto max-w-6xl pointer-events-auto">
        <GlassSurface
          ...
          saturation={0.8}
          distortionScale={-60}
          className="border border-white/10 shadow-2xl shadow-black/30"
        >
          <nav className="flex h-full w-full items-center justify-between px-3 sm:px-4">
            ...
            >
              <span className="flex h-7 w-7 items-center justify-center rounded-md border border-white/15 bg-white/[0.08] text-xs font-bold text-white">
                V
              </span>
              VISA
            </Link>
            ...
            <div className="flex items-center gap-1 text-xs">
              ...
              <span className="ml-2 hidden items-center gap-1.5 border-l border-white/10 pl-3 text-slate-500 sm:flex">
